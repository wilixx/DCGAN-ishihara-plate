...
#     color(0xF9BB82), color(0xEBA170), color(0xFCCD84)
    [color(0xF9BB82), color(0xEBA170), color(0xFCCD84)],
#     [color(0x89B270), color(0x7AA45E), color(0xB6C674)],
#     [color(0x7AA45E), color(0xB6C674), color(0x7AA45E)],
#     [color(0xB6C674), color(0xFECB05), color(0xE96B6C)],
#     [color(0xF7989C), color(0xAD5277), color(0xF7989C)],
#     [color(0xFF934F), color(0xA8AA00), color(0x83BE28)]
]
COLORS_OFF = [
    ...
    [color(0x9CA594), color(0xACB4A5), color(0xBBB964)],
#     [color(0xD7DAAA), color(0xE5D57D), color(0xD1D6AF)],
#     [color(0xF49427), color(0xC9785D), color(0xE88C6A)],
#     [color(0xF1B081), color(0xF49427), color(0xC9785D)],
#     [color(0xE88C6A), color(0x817865), color(0x9C9C84)],
#     [color(0xE88C6A), color(0x817865), color(0x9C9C84)],
#     [color(0x9C9C9C), color(0x828200), color(0x669A1B)],
    [color(0x828200), color(0x669A1B), color(0xED6311)]
#     color(0x9CA594), color(0xACB4A5), color(0xBBB964),
...
def circle_draw(draw_image, image, (x, y, r)):
    ...
    fill_patterns=random.choice(fill_colors)
    fill_color = random.choice(fill_patterns)
...
def main():
    for infile in glob.glob("results/mnist-num-6-640x640-all/*.png"):
        file, ext = os.path.splitext(infile)
        a,file =os.path.split(file)
...
#         date=time.strftime("%Y-%m-%d-%H-%M-%S",date_touple)
        image2.save("results/mnist-num-6-ishihara-all/"+file+".png",'PNG')
